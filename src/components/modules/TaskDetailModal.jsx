...
import { XMarkIcon, PaperClipIcon, LinkIcon } from '@heroicons/react/24/outline';
...
const TaskDetailModal = ({ task, onClose, onTaskUpdate, employees }) => {
  ...
  const defaultValues = {
    ...
    assignee: task?.assignee ? {
      ...
      label: `${task.assignee.firstName} ${task.assignee.lastName} (${task.assignee.role || 'No Role'})`,
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl">
                ...
                <div className="bg-white">
                  <Tab.Group selectedIndex={['details', 'comments', 'attachments'].indexOf(activeTab)} onChange={(index) => setActiveTab(['details', 'comments', 'attachments'][index])}>
                    <Tab.List className="border-b border-gray-200">
                      <div className="flex space-x-8 px-6 pt-6">
                        <Tab className={({ selected }) =>
                          `${selected ? 'border-primary-500 text-primary-600' : 'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'}
                      ...
                      <Tab.Panel className="space-y-6">
                              ...
                              <div className="flex items-center space-x-3">
                                ...
                                <div>
                                  ...
                                  <p className="text-xs text-gray-500">
                                    Added by {attachment.uploadedBy?.firstName} {attachment.uploadedBy?.lastName}
                                  </p>
                                </div>
                              </div>
                              <a
                        ...
                        <div className="space-y-4">
                          ...
                          <div className="border-t border-gray-200 pt-4">
                            <h4 className="text-sm font-medium text-gray-900">Add Link</h4>
                            <div className="mt-2 space-y-2">
                              <input
                                type="text"
